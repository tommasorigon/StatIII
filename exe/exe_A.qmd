...
The dataset `FEV.dat` is [available here](../data/FEV.dat); the first six observations are shown below. In this analysis, let $y$ denote the FEV1 value after one hour of treatment (variable `fev1` in the dataset). Define 
...
Analyze the expected impact of this [measurement error]{.orange} on $\hat{\beta}_1$ and the residuals $\bm{r}$. What does it happen in the special case $\mu_u = 0$?
:::

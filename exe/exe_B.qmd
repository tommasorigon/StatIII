...
(b) Using a forward selection procedure with all five predictors together with judgments about practical signiicance, select and interpret a (generalized) linear model for selling price.

(c) Check whether results depend on any inluential observations.

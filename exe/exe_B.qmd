...
2. $Y_i \sim \text{ED}(\mu_i,\phi \mu_i^2)$ and $\mu_i \in (0, \infty)$, with $\phi$ known.  
3. $Y_i \sim \text{ED}(\mu_i,\mu_i(1 - \mu_i))$ and $\mu_i \in (0, 1)$.  
4. $Y_i \sim \text{ED}(\mu_i, \mu_i)$ and $\mu_i \in (0, \infty)$.
...
ii. Derive the score function $\ell_*(\beta)$ and the expected Fisher information $I$.

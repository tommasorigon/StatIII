...
$$
Hence, the response residuals need not have a mean of $0$. Then, explain why a GLM with a [canonical link]{.orange} function requires the inclusion of an intercept term in order to ensure that this equality holds (assume constant weights $\omega_i$ for simplicity).
:::

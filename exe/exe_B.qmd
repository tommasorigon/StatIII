...
(g) For the same data, considering the untransformed response and using pen and paper, specify a [generalized linear model]{.orange} with Gamma response and logarithmic link function.  

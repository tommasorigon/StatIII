...
(c) Provide a prediction interval for the `GAD` for a mother being exposed to a dose of $100$ (mg/L) of `DDE` and compare it with the prediction for a mother not being exposed to `DDE`. 

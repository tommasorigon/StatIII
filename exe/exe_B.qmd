...
Explicitly derive the contribution of a single observation to the deviance $d_i$ for a Gamma generalized linear model with a canonical link (inverse link). Then, write down the expression of the deviance $D(\hat{\bm{\mu}}; \boldsymbol{y})$ for a sample of size $n$.
:::

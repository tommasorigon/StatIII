...
(a) Visualize the data using scatterplots and other descriptive measures (tables, boxplot, etc). The variables `color` and `spine` should be regarded as categorical. 

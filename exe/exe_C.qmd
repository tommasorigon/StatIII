...
- $\pi_{75F}$ for *O. aegyptiaca* 75 on bean root  
- $\pi_{75C}$ for *O. aegyptiaca* 75 on cucumber root  
- $\pi_{73F}$ for *O. aegyptiaca* 73 on bean root  
- $\pi_{73C}$ for *O. aegyptiaca* 73 on cucumber root  
...
Let $Y \sim \mathrm{Binomial}(\pi, m)$. Consider the logit parametrization $\theta = \log\{\pi/(1-\pi)\}$.  

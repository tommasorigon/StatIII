...
Il valore $\exp(\hat{\beta}_2) = 1.4067$ si può interpretare come rapporto tra quote relativo (*odds ratio*) relativo all'aumentare unitario della concentrazione di etilene. Tale rapporto è positivo e abbastanza elevato, ad indicare un marcato aumento della probabilità di decesso al crescere della variabile `conc`.
...
Anche in questo caso, è possibile specificare due intervalli di confidenza alternativi (entrambi corretti). Confrontati con quelli ottenuti in precedenza, si nota che la loro ampiezza è aumentata come conseguenza della sovradispersione.
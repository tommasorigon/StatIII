...
$$
\hat{\mathbb{E}}(Y_i) = \hat{\pi}_i = \frac{\exp^{-6.010 + 0.341 x_i}}{1 + \exp^{-6.010 + 0.341 x_i}}, \qquad i=1,\dots,10.
$$
```{r}
#| results: hide
# Punto (b.ii)
...
È presente sovradispersione. Il valore di $X^2$ è elevato e al di fuori dei valori tipici, come confermato dal *p-value* associato. Si ottiene inoltre che $\hat{\phi} = X^2 / (n - p) = 4.432$.

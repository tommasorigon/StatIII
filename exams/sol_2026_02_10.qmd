...
È quindi chiaro che la probabilità di insolvenza di uno studente è maggiore di quella di un cliente non studente. In ogni caso, in valori assoluti si tratta di probabilità abbastanza basse in entrambi i casi. In alternativa, si sarebbero potute considerare le quote.

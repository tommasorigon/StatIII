...
- An observation is [influent]{.blue} if it has high leverage and squared residual. [Cook’s distance]{.orange} $d_i$ is based on the change in $\hat{\beta}$ when the observation is removed:
$$

...
-   A few [aspects]{.blue} will be novel to
    most of you...
...
- In the case of transformations applied to the [response]{.orange} variable we let $\mathbb{E}(g(Y_i)) = \bm{x}_i^T\beta$. However, it is not always possible to derive the mean of the original response $\mathbb{E}(Y_i)$. In fact:  
$$

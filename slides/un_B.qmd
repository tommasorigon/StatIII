...
- The [maximum likelihood]{.orange} estimates are $\hat{\beta}_1 = -60.72$ and $\hat{\beta_2} = 34.3$. This gives the [predictive curve]{.blue} $\hat{\pi}(x) = g^{-1}(\hat{\beta}_1 + \hat{\beta}_2x)$, an estimate for the mean proportion $\mathbb{E}(Y_i/m_i)$. 

...
:::callout-warning
The Wald test, the Score test and the log-likelihood ratio test are [asymptotically equivalent]{.blue}, that is, these tests give the same [same number]{.blue} for large values of $n$. We have that
$$

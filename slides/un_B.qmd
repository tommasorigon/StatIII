...
- There are instances in which outliers are actually [contaminated data points]{.blue} (e.g. `age = -3`). If there is strong and contextual evidence that this might the case, then these points should be [removed]{.orange}. Otherwise, removing data points is a [bad practice]{.orange}.
